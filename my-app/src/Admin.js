...
const Admin = () => {
  return (
    <div className="admin">
      ...
      <a href="mailto:owang3@nd.edu,kyee3@nd.edu,ccs@nd.edu?subject=Reimbursement%20Request&body=NETID:%0D%0ANDID:%0D%0AEVENT:%0D%0A">REQUEST REIMBUREMENT FOR OTHER BOARD MEMBERS</a>
